	...
	public static void main(String[] args) throws JMException,
		...
		for(int fun=1;fun<=12;fun++){
		    ...
		    if (args.length == 1) {
		    	...
		    	if(fun == 1) {
		    		problem = new LMF1(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "concave_" + m +"D" +".pf");
		    	}
		    	if(fun == 2) {
		    		problem = new LMF2(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "convex_" + m +"D" +".pf");
		    	}
		    	if(fun == 3) {
		    		problem = new LMF3(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "linear_" + m +"D" +".pf");
		    	}
		    	if(fun == 4) {
		    		problem = new LMF4(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "concave_" + m +"D" +".pf");
		    	}
		    	if(fun == 5) {
		    		problem = new LMF5(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "convex_" + m +"D" +".pf");
		    	}
		    	if(fun == 6) {
		    		problem = new LMF6(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "linear_" + m +"D" +".pf");
		    	}
		    	if(fun == 7) {
		    		problem = new LMF7(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "concave_" + m +"D" +".pf");
		    	}
		    	if(fun == 8) {
		    		problem = new LMF8(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "linear_" + m +"D" +".pf");
		    	}
		    	if(fun == 9) {
		    		m = 3;
		    		problem = new LMF9(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "inverted_concave_" + m +"D" +".pf");
		    	}
		    	if(fun == 10) {
		    		m = 3;
		    		problem = new LMF10(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "inverted_linear_" + m +"D" +".pf");
		    	}
		    	if(fun == 11) {
		    		m = 3;
		    		problem = new LMF11(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "inverted_concave_" + m +"D" +".pf");
		    	}
		    	if(fun == 12) {
		    		m = 3;
		    		problem = new LMF12(n,m,tp1,tp2,tp3,tp4);
		    		indicators = new QualityIndicator(problem,"D:\\Matlab\\TruePF\\LMF\\" + "inverted_linear_" + m +"D" +".pf");
		    	}
		    } // else
		    for(int i=0;i<runtimes;i++){
		    	...
		    	if(m == 2) {
		    		...
		    		algorithm.setInputParameter("maxGenerations", 10000);
		    		...
		    		algorithm.setInputParameter("maxGenerations", 3268);
		    	...
		    	// Result messages
		    	//population.printObjectivesToFile("GLEAP6_"+ tp1+tp2+tp3+tp4+ "_" + problem.getNumberOfObjectives()+"Obj_"+problem.getName()+ "_" + problem.getNumberOfVariables() + "D_run"+(i+1)+".txt" );
